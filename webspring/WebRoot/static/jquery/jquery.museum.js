    ...
    $.museum = function(el, options) {
        ...
        var init = function() {
            ...
            plugin.el.each(function(i, e) {
                ...
                $(this).wrap($('<a>').attr('href', src).unbind('click').bind('click', function(ev){
                    if(!ev.metaKey) {
                        ev.preventDefault();
                        plugin.show_image(i);
                    }
        ...
        plugin.show_image = function(i) {
            if(plugin.loaded === false) {
                ...
                $('<div>').appendTo($('body')).addClass('template-bj').css({
                    'position': 'absolute',
                    'top': '0',
                    'left': '0',
                    'width': $(document).width() + 'px',
            ...
            plugin.image = $('<img>')
                ...
                .attr('src', plugin.images[i].src).removeAttr('width').removeAttr('height')
        ...
        //setTimeout(plugin.show_image_when_available, 300);
